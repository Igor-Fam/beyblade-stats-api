...
const translations = {
  en: {
    ...
    modal_help_efficiency_desc: 'Calculated based on the number of wins, types of finishes, and the strength of the opponents faced.',
    dep_with: 'With {part}:',
  ...
  pt: {
    ...
    min_battles_label: 'Mín. de Batalhas',
    ...
    modal_help_efficiency_desc: 'Calculada com base na quantidade de vitórias, tipos de finalização e força dos oponentes enfrentados.',
    dep_with: 'Com {part}:',
